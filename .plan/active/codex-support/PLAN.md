...
Step 3's implementation reviews rejected two checkpoints. Parent-probed queue/history/transport/cleanup fixes are
implemented locally; another focused independent review remains required before publication.
